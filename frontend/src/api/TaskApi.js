...
class TaskApi extends Api {
    ...
    async createTask(task) {
        try {
            const response = await this.axios.post("/addTask", task);
            return response.data;
        } catch (error) {
    ...
    async updateTask(id,task) {
        try {
            const response = await this.axios.put(`/updateTask/${id}`, task);
            return response.data;
        } catch (error) {
    ...
    async deleteTask(id) {
        try {
            const response = await this.axios.delete(`/deleteTask/${id}`);
            return response.data;
        } catch (error) {
